...
open class Floaty: UIView {
    ...
    @objc open func open() {
        ...
        if(items.count > 0){
            ...
            self.circleLayer.backgroundColor = buttonColor.withAlphaComponent(1.0).cgColor
            self.plusLayer.backgroundColor = buttonColor.withAlphaComponent(1.0).cgColor
    ...
    @objc open func close() {
        ...
        let animationGroup = DispatchGroup()
        self.buttonImageView.alpha = 0.3
        self.circleLayer.backgroundColor = buttonColor.withAlphaComponent(0.3).cgColor
        self.plusLayer.backgroundColor = buttonColor.withAlphaComponent(0.3).cgColor
        if(items.count > 0){
    ...
    fileprivate func setCircleLayer() {
        ...
        circleLayer.backgroundColor = buttonColor.withAlphaComponent(0.3).cgColor
    ...
    fileprivate func setPlusLayer() {
        ...
        plusLayer.strokeColor = plusColor.withAlphaComponent(0.3).cgColor
