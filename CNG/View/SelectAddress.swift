...
class SelectAddress: UIView {
    ...
    override init(frame: CGRect) {
        ...
        SelectAddressItem.registerCellByClass(self.tableView)
...
extension SelectAddress: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = SelectAddressItem.loadCell(tableView) as! SelectAddressItem
        if (self.isSearching()) {
...
extension SelectAddress: SelectAddressDelegate {
...
class SelectAddressItem: BaseTableCell{
